...
function [cost, comp ] =calibrate_intel_cost(calib,depth_points,depth_depth,conf_grid_x,conf_grid_p,rgb_grid_p)

    [cost_depth, comp] = calibrate_intel_cost_depth(calib,depth_points,depth_depth,conf_grid_x,conf_grid_p);
